...
const featureBlocks = [
  ...
  type: 'quote',
  eyebrow: 'Wonder',
  quote: 'Friendship, Exploration, Discovery and Deceipt all in a land far stranger than Jen ever imagined',
...
},
  {
    ...
    description: 'When Jen decides to try to avoid judgement, did she just forfit mercy as well? Will she have the courage to tell the truth, or be able to continue her ruse?',
  ...
  },
  {
    type: 'image',
    eyebrow: 'Wisdom',
    title: 'Discover, with Jen, the strange country that might just cost her everything',
